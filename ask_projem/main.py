...
if not st.session_state['authenticated']:
    ...
    if os.path.exists(SIIR_DOSYASI):
        try:
            # Excel'i oku (Başlık satırı olduğunu varsayıyoruz)
    ...
    if page == "Günün Sürprizi":
        if is_valentine:
            ...
            # Fotoğraf: WhatsApp Image 2026-02-12 at 17.05.21.jpeg
            ozel_foto_adi = "WhatsApp Image 2026-02-12 at 17.05.21.jpeg"
            ozel_foto_yolu = os.path.join(FOTO_KLASORU, ozel_foto_adi)

            # Şiir: Excel'deki A4 satırı (Pandas'ta 2. indeks: Başlık=0, A2=0, A3=1, A4=2)
            # Eğer Excel'de başlık yoksa iloc[3, 0] kullanmalısın.
            try:
                ozel_siir = df.iloc[2, 0]  # A4 hücresi
            except:
            ...
            # NORMAL GÜNLERDE RASTGELE SEÇİM
